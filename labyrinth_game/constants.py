...
ROOMS = {
    ...
    'secret_garden': {
            'description': 'Заброшенный сад с искрящимся фонтаном. В воздухе пахнет магией.',
            'exits': {'west': 'armory', 'up': 'observatory'},
            'items': ['magic_flower'],
            'puzzle': ('Фонтан шепчет: "В центре парка или сада, \nНикому я не преграда; \nМой цветок подобен раю, \nЯ — водою расцветаю,"', 'фонтан')
    },
    'observatory': {
            'description': 'Круглая комната с куполом из хрусталя. Телескоп направлен на звезды.',
            'exits': {'down': 'secret_garden'},
            'items': ['star_map'],
            'puzzle': ('На табличке написано: "Сколько планет в Солнечной системе?" (ответ цифрой)', '8')
    }
}